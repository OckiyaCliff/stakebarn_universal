...
function FAQItem({ question, answer, isOpen, onClick }: { question: string; answer: string; isOpen: boolean; onClick: () => void }) {
  return (
    <div className="border border-border/50 rounded-xl overflow-hidden hover-lift">
      <button
        onClick={onClick}
      ...
      <div className={`overflow-hidden transition-all duration-300 ${isOpen ? "max-h-96" : "max-h-0"}`}>
        <p className="p-5 pt-0 text-muted-foreground bg-card/50">{answer}</p>
      </div>
    </div>
  );
}
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center">
          <div className="mx-auto max-w-4xl px-6 py-24 text-center">
            <div className="animate-slide-up">
              <span className="inline-flex items-center gap-2 rounded-full bg-white/5 backdrop-blur-sm border border-white/10 px-4 py-1.5 text-sm font-medium text-foreground mb-8">
            ...
            <h1 className="animate-slide-up animation-delay-100 text-5xl font-bold tracking-tight text-foreground sm:text-7xl lg:text-8xl text-balance leading-[1.1]">
              Stake your crypto.
              <br />
            ...
            <div className="animate-slide-up animation-delay-300 mt-10 flex items-center justify-center gap-4 flex-wrap">
              <Button asChild size="lg" className="rounded-full px-8 gap-2 glow-primary text-base">
                <Link href="/auth/sign-up">
                  Get started <ArrowRight className="h-4 w-4" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="rounded-full px-8 bg-transparent border-white/20 hover:bg-white/5 text-base">
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {steps.map((step, index) => (
            <div
              key={step.number}
              className="relative text-center p-8 rounded-2xl border border-border/30 bg-card/30 backdrop-blur-sm hover-lift"
            >
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-primary/10 text-primary text-xl font-bold mb-6">
                {step.number}
              </div>
      ...
      <section id="features" className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div
              key={feature.title}
              className="relative overflow-hidden rounded-2xl border border-border/30 bg-card/30 backdrop-blur-sm p-6 hover-lift group"
            >
      ...
      <section id="currencies" className="bg-card/20 border-y border-border/30">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {testimonials.map((testimonial) => (
            <div
              ...
              className="rounded-2xl border border-border/30 bg-card/30 backdrop-blur-sm p-6 hover-lift"
            >
              ...
              <p className="text-muted-foreground mb-6 text-sm leading-relaxed">&ldquo;{testimonial.content}&rdquo;</p>
      ...
      <section className="bg-card/20 border-y border-border/30">
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
          ...
          <div className="mt-12 text-center">
            ...
            <Button asChild variant="outline" className="rounded-full bg-transparent border-border/40">
      ...
      {/* Partners Section */}
      <section id="partners" className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-2xl text-center mb-16">
          <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
        ...
        <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-6 items-center">
          {[
            ...
            <div
              key={partner.name}
              className="flex items-center justify-center rounded-xl border border-border/20 bg-card/20 p-6 h-20 grayscale hover:grayscale-0 transition-all duration-300 hover-lift"
            >
              <img
                src={partner.logo}
                alt={partner.name}
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="rounded-3xl bg-gradient-to-r from-primary/15 via-primary/5 to-transparent border border-border/30 p-8 md:p-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-center md:text-left">
              ...
              <p className="text-muted-foreground">
                Join thousands of stakers earning passive income daily. Get a $15 welcome bonus!
              </p>
            </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {[
            ...
            <Link
              key={post.slug}
              href={`/blog/${post.slug}`}
              className="group rounded-2xl border border-border/30 bg-card/30 backdrop-blur-sm overflow-hidden hover-lift"
            >
        ...
        <div className="mt-12 text-center">
          <Button asChild variant="outline" size="lg" className="rounded-full bg-transparent border-border/40">
