    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground text-pretty">
              StakeBarn Universal offers secure, flexible staking for ETH, BTC, SOL, and XRP. Start earning passive
              income with competitive APYs and transparent rewards.
            </p>
      ...
      <div id="features" className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-2xl text-center mb-16">
          <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Why Choose StakeBarn?</h2>
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="relative overflow-hidden rounded-lg border border-border bg-card p-6">
            ...
            <h3 className="mt-4 text-lg font-semibold text-card-foreground">High APY</h3>
            <p className="mt-2 text-sm text-muted-foreground">
              Earn up to 22% APY on your crypto holdings with our competitive staking plans
            </p>
          </div>
          ...
          <div className="relative overflow-hidden rounded-lg border border-border bg-card p-6">
            ...
            <h3 className="mt-4 text-lg font-semibold text-card-foreground">Secure</h3>
            <p className="mt-2 text-sm text-muted-foreground">
              Your assets are protected with industry-leading security and blockchain verification
            </p>
          </div>
          ...
          <div className="relative overflow-hidden rounded-lg border border-border bg-card p-6">
            ...
            <h3 className="mt-4 text-lg font-semibold text-card-foreground">Flexible</h3>
            <p className="mt-2 text-sm text-muted-foreground">
              Choose between flexible or locked staking plans that fit your investment strategy
            </p>
          </div>
          ...
          <div className="relative overflow-hidden rounded-lg border border-border bg-card p-6">
            ...
            <h3 className="mt-4 text-lg font-semibold text-card-foreground">Transparent</h3>
            <p className="mt-2 text-sm text-muted-foreground">
              Real-time tracking of your deposits, stakes, and rewards with full transparency
            </p>
          </div>
        </div>
      </div>
      ...
      <div id="currencies" className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-2xl text-center mb-16">
          <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Supported Cryptocurrencies</h2>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          {[
            ...
            <div key={currency.symbol} className="rounded-lg border border-border bg-card p-6 text-center">
              <div className="text-2xl font-bold text-card-foreground">{currency.symbol}</div>
              <div className="mt-1 text-sm text-muted-foreground">{currency.name}</div>
              <div className="mt-3 text-sm font-semibold text-primary">{currency.apy}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div id="partners" className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:grid-cols-6 items-center">
          {[
            { name: "Binance", query: "binance logo" },
            ...
            >
              <img
                src={`/.jpg?key=jr633&height=40&width=120&query=${encodeURIComponent(partner.query)}`}
                alt={partner.name}
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-2xl text-center mb-16">
          <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Latest from Our Blog</h2>
          <p className="mt-4 text-lg text-muted-foreground">
            Stay updated with the latest news, insights, and guides on crypto staking
          </p>
        </div>
          ...
          {[
            ...
            >
              <div className="aspect-video rounded-lg bg-muted mb-4 overflow-hidden">
                <img
                  src={`/.jpg?key=eh4cm&height=200&width=400&query=${encodeURIComponent(post.title)}`}
                  alt={post.title}
